...
<template>
  <div class="page">
    ...
    <div class="sub-title">
      <div>
        <span v-for="(subitem, subindex) in subTitle" :key="index">{{subitem}}</span>
      </div>
      <div>
    ...
    <div class="chart-list" v-for="(item, index) in chart" :key="index" ref="div">
      <div v-show="item.title">
        <span v-for="(subitem, subindex) in item.title" :key="index">{{subitem}}</span>
      </div>
      <div></div>
    </div>
    ...
    <div class="table tables" ref="table" v-for="(table, tableIndex) in table" :key="tableIndex">
      <p class="table-title">
        <span v-for="(subitem, subindex) in table.title" :key="index">{{subitem}}</span>
      </p>
      <table>
        <thead>
          <tr>
